...
export const ENTITIES = {
  ...
  // Module Marché+ (clone du module Marché)
  MP_PPM_PLAN: 'MP_PPM_PLAN',
  MP_OPERATION: 'MP_OPERATION',
  MP_BUDGET_LINE: 'MP_BUDGET_LINE',
  MP_LIVRABLE: 'MP_LIVRABLE',
  MP_PROCEDURE: 'MP_PROCEDURE',
  MP_RECOURS: 'MP_RECOURS',
  MP_ATTRIBUTION: 'MP_ATTRIBUTION',
  MP_ECHEANCIER: 'MP_ECHEANCIER',
  MP_CLE_REPARTITION: 'MP_CLE_REPARTITION',
  MP_VISA_CF: 'MP_VISA_CF',
  MP_ORDRE_SERVICE: 'MP_ORDRE_SERVICE',
  MP_AVENANT: 'MP_AVENANT',
  MP_RESILIATION: 'MP_RESILIATION',
  MP_GARANTIE: 'MP_GARANTIE',
  MP_CLOTURE: 'MP_CLOTURE',
  MP_ENTREPRISE: 'MP_ENTREPRISE',
  MP_GROUPEMENT: 'MP_GROUPEMENT',
  MP_ANO: 'MP_ANO',
...
export const SCHEMAS = {
  ...
  // ============================================
  // MODULE MARCHÉ+ - Schemas (clone indépendant)
  // ============================================
